...
public class MercuryActivity extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.desc_mercury);
        ...
        arrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(MercuryActivity.this, HomeActivity.class);
        ...
        buttonNavigate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent =new Intent(MercuryActivity.this, SearchActivity.class);
                startActivity(intent);
            }
        });
