...
public class JupiterActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.desc_jupiter);
            ...
            arrowback.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent =new Intent(JupiterActivity.this, HomeActivity.class);
            ...
            buttonNavigate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent =new Intent(JupiterActivity.this, SearchActivity.class);
                    startActivity(intent);
                }
            });
