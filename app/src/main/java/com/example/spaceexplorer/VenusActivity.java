...
public class VenusActivity extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.desc_venus);
        ...
        arrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(VenusActivity.this, HomeActivity.class);
        ...
        buttonNavigate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent =new Intent(VenusActivity.this, SearchActivity.class);
                startActivity(intent);
            }
        });
